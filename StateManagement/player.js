...
export default class Player {
    constructor(gameWidth, gameHeight) {
        ...
        this.states = [new StandingLeft(this), new StandingRight(this),
                    ...
                    new FallingLeft(this), new FallingRight(this)]; // 0 presents standing left, and 1 presents standing right
    ...
    setState(state) {
        ...
        this.currentState.enter(); //change the frameY for change the position direction
    }
